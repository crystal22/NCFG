...
def load_data(args):
    ...
    user_set = {interaction[0] for interaction in ratings_np}
    item_set = {interaction[1] for interaction in ratings_np}
    ...
    all_records = train_records.copy()
    all_records.update(get_item_record(item_set, train_records))
    ripple_sets = get_ripple_set(all_records, kg_dict, args.L, args.K)
