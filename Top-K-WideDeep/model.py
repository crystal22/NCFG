...
class WideDeep(nn.Module):
    ...
    def __init__(self, int_dim, dim, embedding_matrix, n_user, is_pre):
        # t.manual_seed(255)
        # t.cuda.manual_seed(255)
        super(WideDeep, self).__init__()
        embedding_matrix = t.randn(embedding_matrix.shape[0], dim)
    ...
    def forward(self, pairs):
        ...
        user_vectors = self.user_embedding_matrix[[pair[0] for pair in pairs]]
        item_vectors = self.embedding_matrix[[pair[1] for pair in pairs]]
